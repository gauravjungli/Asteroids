...
{           double factor=1;
	...
	wtemp[res + 2].p = wtemp[res + 1].p;wtemp[res + 2].q = -wtemp[res + 1].q;wtemp[res + 2].r = wtemp[res + 1].r;
	wtemp[res + 3].p = wtemp[res].p;    wtemp[res + 3].q = -wtemp[res].q;    wtemp[res + 3].r = wtemp[res].r;
	...
	wtemp[res + 2].p = wtemp[res + 1].p;wtemp[res + 2].q = -wtemp[res + 1].q;wtemp[res + 2].r = wtemp[res + 1].r;
    wtemp[res + 2].h = wtemp[res + 1].h;wtemp[res + 2].u = -wtemp[res + 1].u;wtemp[res + 2].v = (1 + theta) * wtemp[res + 1].v - theta * wtemp[res].v;
	wtemp[res + 3].p = wtemp[res].p;wtemp[res + 3].q = -wtemp[res].q;wtemp[res + 3].r = wtemp[res].r;
    wtemp[res + 3].h = wtemp[res].h;wtemp[res + 3].u = -wtemp[res].u;wtemp[res + 3].v = (1 + 2 * theta) * wtemp[res + 1].v - 2 * theta * wtemp[res].v;
}